...
#
# 1.4	adjusted for vlerq
# 1.5 fixed to actually work
# 1.6 minor cleanup

package provide vfs::m2m 1.6
package require vfs
...
# private
  proc makeDirsView {} {
    set d {}
    foreach f $v::files {
      lappend d [view {name size:I date:I contents:B} vdef [eval concat $f]]
    }
    set dirs [view {name parent:I {files {name size:I date:I contents:B}}} \
                      vdef $v::dname $v::prows $d]
    view $dirs group dirs
  }
